...
export default function About() {
  return (
    <Layout title={`Privacy Policy`} description="Get to know your rights!">
      <header
        className={clsx(
          'hero hero--primary',
          styles.heroBanner,
        ...
        <div className="container">
          ...
          <p className="hero__subtitle">Get to know your rights!</p>
            ...
            <div className={styles.about}>
              <div className={styles.aboutText}>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      <strong>Application</strong> refers to Hope's Portfolio,
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to Hope's
                      Portfolio.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to Hope's Portfolio,
                      accessible from{' '}
                      <a
                        href="http://umutyildirim.com/"
                        rel="external nofollow noopener"
                        target="_blank">
                        http://umutyildirim.com/
                      </a>
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    ...
                    <a
                      href="http://umutyildirim.com/privacy"
                      rel="external nofollow noopener"
                      target="_blank">
                      http://umutyildirim.com/privacy
                    </a>
                  </li>
                </ul>
              </div>
