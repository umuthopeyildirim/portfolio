...
export default function About() {
  ...
  return (
    <Layout
      ...
      description="Get to know your rights!">
          ...
          <section className={styles.features}>
            <div className="container">
              <div className={styles.about}>
                ...
                <li>
                <p><strong>Application</strong> refers to Hope's Portfolio, the software program provided by the Company.</p>
                </li>
                <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Hope's Portfolio.</p>
                </li>
                <li>
                ...
                <li>
                <p><strong>Website</strong> refers to Hope's Portfolio, accessible from <a href="http://umutyildirim.com/" rel="external nofollow noopener" target="_blank">http://umutyildirim.com/</a></p>
                </li>
                <li>
                ...
                <ul>
                <li>By visiting this page on our website: <a href="http://umutyildirim.com/privacy" rel="external nofollow noopener" target="_blank">http://umutyildirim.com/privacy</a></li>
                </ul>
                </div>
              </div>
            </div>
